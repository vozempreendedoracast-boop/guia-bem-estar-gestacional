...
export const weeksData: WeekData[] = [
  ...
  { week: 5, babySize: "3mm", babySizeComparison: "🫘 Grão de lentilha", babyDevelopment: "O coração começa a bater! Braços e pernas começam como brotos.", motherChanges: "Enjoos podem se intensificar. Frequência urinária aumenta.", commonSymptoms: ["Enjoo intenso", "Frequência urinária", "Mudanças de humor"], alerts: ["Marque sua primeira consulta pré-natal"], tip: "Gengibre e limão podem ajudar com enjoos." },
  { week: 6, babySize: "6mm", babySizeComparison: "🫐 Ervilha", babyDevelopment: "O rosto começa a se formar. Olhos e narinas aparecem como manchas.", motherChanges: "Cansaço extremo e enjoos são comuns.", commonSymptoms: ["Náusea", "Fadiga extrema", "Inchaço"], alerts: [], tip: "Tente dormir mais cedo e tire cochilos quando possível." },
  { week: 7, babySize: "1,3cm", babySizeComparison: "🫐 Mirtilo", babyDevelopment: "O cérebro está crescendo rapidamente. Mãos e pés se formam.", motherChanges: "Salivação excessiva pode ocorrer. Aversões alimentares.", commonSymptoms: ["Salivação", "Aversões alimentares", "Cólicas leves"], alerts: [], tip: "Evite alimentos com odores fortes se causar náusea." },
  ...
  { week: 11, babySize: "4cm", babySizeComparison: "🍋 Figo", babyDevelopment: "O bebê pode bocejar e soluçar! Os genitais começam a se diferenciar.", motherChanges: "Enjoos podem começar a diminuir. Energia voltando aos poucos.", commonSymptoms: ["Azia", "Gases", "Mais energia"], alerts: [], tip: "Aproveite o retorno da energia para fazer atividades leves." },
  ...
  { week: 14, babySize: "8,7cm", babySizeComparison: "🍊 Pêssego", babyDevelopment: "O bebê faz expressões faciais. Lanugo (pelinhos finos) cobre o corpo.", motherChanges: "Apetite aumenta. Disposição melhora bastante.", commonSymptoms: ["Mais apetite", "Dores ligamentares", "Congestão nasal"], alerts: [], tip: "Comece a hidratar a barriga para prevenir estrias." },
  ...
  { week: 32, babySize: "43cm", babySizeComparison: "🍍 Abacaxi", babyDevelopment: "O bebê está ganhando gordura. Unhas crescidas. Prática de respiração.", motherChanges: "Barriga grande. Contrações de Braxton Hicks podem começar.", commonSymptoms: ["Braxton Hicks", "Pressão pélvica", "Cansaço"], alerts: ["Monte a mala da maternidade"], tip: "Comece a preparar a mala da maternidade." },
  { week: 36, babySize: "47cm", babySizeComparison: "🥬 Alface romana", babyDevelopment: "O bebê está encaixando na posição de parto. Pulmões quase maduros.", motherChanges: "Pressão na bexiga intensa. Pode respirar melhor com o bebê descendo.", commonSymptoms: ["Pressão na bexiga", "Dificuldade para caminhar", "Ansiedade"], alerts: ["Consultas semanais", "Strep B test"], tip: "Pratique técnicas de respiração para o parto." },
